...
import { View, ImageBackground, ScrollView, Box, HStack, Pressable, Text, Image } from '@gluestack-ui/themed';
    ...
    return (
        <View height="$full">
            <ImageBackground source={BackgroundImage} minHeight={'$full'}>
                ...
                <ScrollView>
                    <Box height={5} />
                    <Pressable onPress={() => Linking.openURL("https://youtu.be/oDPOHMFcFsA?feature=shared")}>
                        <Box
                            bg="white"
                            p={4}
                            my={4}
                    ...
                    <Box height={5} />
                    <Pressable onPress={() => Linking.openURL("https://youtu.be/Mwp9Cmgz2cw?feature=shared")}>
                        <Box
                            bg="white"
                            p={4}
                            my={4}
                            ...
                            borderWidth={2} // Border width
                        >
                             <TextBold>Breathing Exercide</TextBold>
                            <Image
                                source={TeacherPic2}
                                alt="Teacher"
                                width={70} // Adjust the width here
                    ...
                    <Box height={5} />
                    <Pressable onPress={() => Linking.openURL("https://youtu.be/nCNS-Lpubaw?feature=shared")}>
                        <Box
                            bg="white"
                            p={4}
                            my={4}
                    ...
                    <Box
                        ...
                        borderWidth={2} // Border width
                    >
                        <Text fontWeight="bold"> {/* Make the text bold */}
                            Remember, taking care of your health is essential for a happy and fulfilling life!
                        </Text>
                    </Box>
                </ScrollView>
            </ImageBackground>
