...
import TicTacToeBoard from '../../components/molecules/GameBoard';
  ...
  return (
    <View height={'$full'}>
      <ImageBackground source={BackgroundImage} h="$full">
        <Box />
        <StatusBarStudent text="TIC TAC TOE" bgColor="$orange300" />
        <Box height={'$12'} />
        <Center><Image source={MathsImage} alt='MathsImage' h='$32' w = '$40'/></Center>
        <ScrollView
